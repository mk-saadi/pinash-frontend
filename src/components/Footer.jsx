...
const Footer = () => {
	return (
		<div className="bg-[#F4F4F6] px-1 xl:px-0s">
			<div className="mx-auto pt-28 pb-36 xl:w-[1148px] ">
				<div className="text-[#000000B2] flex md:flex-row gap-y-7 flex-col justify-between items-start text-sm xl:text-base">
					<nav className="flex flex-col justify-start gap-y-1.5 xl:gap-y-3">
						<h6 className="text-[13px] text-[#00000080] mb-2 xl:mb-5">Categories</h6>
					...
					<nav className="flex flex-col justify-start gap-y-1.5 xl:gap-y-3">
						<h6 className="text-[13px] text-[#00000080] mb-2 xl:mb-5">About</h6>
						<a>About us</a>
						<a>Our partner</a>
						<a>Investors</a>
						<a>Career</a>
					...
					<nav className="flex flex-col justify-start gap-y-1.5 xl:gap-y-3">
						<h6 className="text-[13px] text-[#00000080] mb-2 xl:mb-5">Resources</h6>
						<a>FAQ</a>
						<a>Refund policies</a>
					...
					<nav className="flex flex-col justify-start gap-y-1.5 xl:gap-y-3">
						<h6 className="text-[13px] text-[#00000080] mb-2 xl:mb-5">Support</h6>
						<a>Get in touch</a>
						<a>Visit our forum</a>
					</nav>
				</div>
				<div
					className="border-y border-dashed border-[#00000033] py-4 xl:py-8 mt-10"
					style={{
						borderImage:
