		...
		<div>
			...
			>
				{data.map((da) => (
					<SwiperSlide
						key={da.id}
						className=" w-[400px] rounded-xl hover:shadow-md group hover:cursor-pointer duration-300 hover:bg-[#9998E11A] border hover:border-[#9998E1] duration-300 overflow-hidden h-[230px]"
					>
						<Items data={da} />
					</SwiperSlide>
				))}
			</Swiper>
			<div className="absolute flex items-center justify-end w-full h-full gap-x-6 right-24 -top-72">
				<button
					ref={prevRef}
					className={` focus:outline-0 backdrop-blur-sm z-10 p-3 duration-300 transform rounded-full shadow-md 
                            ${
								isBeginning
	...
	return (
		<div className="pb-5 ">
			<div className="relative flex flex-col items-center justify-center w-full mb-1 rounded-md">
				...
				<div className="m-4">
					<div className="flex items-center justify-start text-sm gap-x-4">
						<p className="bg-[#FF97001A] rounded-[5px] py-1 px-2 border border-[#FF970080]">
							{data?.badge1}
						</p>
						<p className="bg-[#CDE53333] rounded-[5px] py-1 px-2 border border-[#CDE533]">
							{data?.badge2}
						</p>
					</div>
					<h1 className="mt-4 text-2xl font-semibold tracking-tighter line-clamp-2">
						{data?.title}
					</h1>
					<div className="flex items-center justify-start mt-4 gap-x-2 mb-14">
						<ul>
					...
					{/* reading */}
					<div className="flex items-center pb-2 justify-start border-b border-[#00000033] gap-x-4">
					...
					<div className="flex items-center justify-between mt-6">
						<div className="flex items-center justify-start gap-x-2">
							<img
								src={data.authorPic}
								alt=""
								className="h-[42px] w-auto rounded-full border shadow-sm"
							/>
